...
# 新しいシンボリックリンクを作成
ln -fs /home/${GRPNAME}/ftp_test/vas/playlist batch/news_test/playlist
ln -fs /home/${GRPNAME}/ftp/vas/playlist      batch/news/playlist
ln -fs /home/${GRPNAME}/ftp_test/vas/playlist web/news_test/playlist
ln -fs /home/${GRPNAME}/ftp/vas/playlist      web/news/playlist
